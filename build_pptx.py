...
# timeline visual (text-based)
timeline = [
    ("2015", "Debt: $12.3 B", LIGHT_TEXT),
    ("2019", "Debt: $29.1 B  (+137 %)", RED_WARN),
    ("Nov 2020", "Eurobond DEFAULT", RED_WARN),
]
tl_left = Inches(7.2)
tl_top  = Inches(1.8)
tl_gap  = Inches(1.6)
for i, (yr, label, col) in enumerate(timeline):
    x = tl_left
    y = tl_top + i * tl_gap
    add_rect(s2, x, y, Inches(4.9), Inches(1.2), DIVIDER)
    add_textbox(s2, x + Inches(0.15), y + Inches(0.1), Inches(1.2), Inches(0.38),
                yr, 11, bold=True, color=ACCENT)
    add_textbox(s2, x + Inches(0.15), y + Inches(0.5), Inches(4.5), Inches(0.55),
...
# copper price annotation
add_rect(s3, Inches(7.3), Inches(4.0), Inches(5.85), Inches(1.1), DIVIDER)
add_textbox(s3, Inches(7.5), Inches(4.1), Inches(5.5), Inches(0.35),
            "COPPER PRICE — PEAK", 9, color=MID_TEXT)
add_textbox(s3, Inches(7.5), Inches(4.42), Inches(2.5), Inches(0.5),
            "~$10,700 /t", 20, bold=True, color=ACCENT)
add_textbox(s3, Inches(10.0), Inches(4.5), Inches(3.0), Inches(0.4),
            "May 2021 LME high", 10, color=MID_TEXT)
...
# ══════════════════════════════════════════════════════════════════════════════
# SLIDE 6 — The Verdict + Call to Action
# ══════════════════════════════════════════════════════════════════════════════
